...
Issues 002 and 006 are implemented together on `codex/issues-002-006-connections` and are ready for native visual and credentialed-provider acceptance.
The delivery adds provider-only connection screens, Keychain and encrypted-server boundaries, validation seams, explicit repair/reconnection states, and last-known evidence retention.
It does not claim live YouTube, Google Trends, Instagram, X, or AI provider access.
